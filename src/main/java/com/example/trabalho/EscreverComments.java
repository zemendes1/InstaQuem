...
public class EscreverComments extends Page implements Initializable {
    ...
    public void mouse_in (){
        ...
        else if(texto_amigos_c.isHover()){
            texto_amigos_c.setEffect(glow);
        }
        else{
